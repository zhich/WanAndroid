 ...
 */
class CustomDecoration(context: Context, orientation: Int, drawable: Int, private val mInset: Int) : RecyclerView.ItemDecoration() {
    ...
    init {
        this.mPaint.color = context.resources.getColor(R.color.white)
